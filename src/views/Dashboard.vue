      ...
      <header
        ...
        <div class="flex grow flex-col items-center justify-between flex-row xl:px-6 border-b">
          <div
            ...
            <button
              class="z-99999 flex h-10 w-10 items-center justify-center rounded-lg text-gray-500 xl:h-11 xl:w-11 border"
          ...
          <div
            class="w-full items-center justify-between gap-4 px-5 py-4 flex justify-end xl:px-0 shadow-none">
            <button
              class="z-99999 flex h-10 w-10 items-center justify-center rounded-lg text-gray-500 h-11 w-11 border"
              @click="darkMode = !darkMode">
              <svg v-if="darkMode" class="fill-current xl:block" width="20" height="20" viewBox="0 0 20 20" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
